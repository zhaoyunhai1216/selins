...
public class AppStore {
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        AppStoreRMI.init();
        logger.info("[Cluster] AppStore [" + Configuration.getInstance().getConf().getString("cluster.host")
                + ":" + Configuration.getInstance().getConf().getInteger("cluster.appstore.port") + "] is start-up successfully.");
    }
